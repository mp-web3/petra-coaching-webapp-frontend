export type PlanSlug =
    | 'woman-premium-6w' | 'woman-premium-18w' | 'woman-premium-36w'
    | 'woman-starter-6w' | 'woman-starter-18w' | 'woman-starter-36w'
    | 'man-premium-6w' | 'man-premium-18w' | 'man-premium-36w'
    | 'man-starter-6w' | 'man-starter-18w' | 'man-starter-36w';
...
export const plansWomanPremium: UiPlan[] = [
    {
        slug: 'woman-premium-6w', title: 'premium 6 settimane', subtitle: '6 settimane (+ di 1 mese)', priceLabel: '€150', highlighted: true,
        features: [
            {
                id: '1',
    ...
    {
        slug: 'woman-premium-18w', title: 'premium 18 settimane', subtitle: '18 settimane (+ di 4 mesi)', priceLabel: '€405', highlighted: true,
        features: [
            {
                id: '1',
                label: '1 consulenza video iniziale'
    ...
    {
        slug: 'woman-premium-36w', title: 'premium 36 settimane', subtitle: '36 settimane (+ di 8 mesi)', priceLabel: '€750', highlighted: true,
        features: [
            {
                id: '1',
                label: '1 consulenza video iniziale'
...
export function getPlanBySlug(slug: string): UiPlan | undefined {
    const allPlans = [...plansWomanPremium, /* Add plansWomanStarter */ /* Add plansManStarter */ /* Add plansManPremium */]
