import { HStack, Heading, Stack, Text, VStack, Image } from '@chakra-ui/react'
...
function FeatureRow({ featureIconSrc, featureIconAlt, featureTitle, featureText }: FeaturesItem) {
    return (
...
export default function Features (props: FeaturesListProps | FeatureSingleProps) {
    ...
    return <FeatureRow featureIconSrc={featureIconSrc} featureIconAlt={featureIconAlt} featureTitle={featureTitle} featureText={featureText} />
}
