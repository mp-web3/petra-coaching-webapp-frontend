...
export default function FeatureCard({ iconSrc, iconAlt, title, description, variant = 'light', align = 'center', rounded = 'lg', hasCardBorder = false }: FeatureCardProps) {
    const isDark = variant === 'dark'
    const bg = hasCardBorder ? (isDark ? 'neutralDark.dark' : 'neutralLight.default') : 'transparent'
    ...
    return (
        ...
        >
            ...
            <Text maxW={{ md: 'sm' }} color={textColor}>{description}</Text>
        </VStack>
    )
}
